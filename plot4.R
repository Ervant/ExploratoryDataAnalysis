...
# plot 2 (top-right)
plot(data_small$DateTime_fmt, data_small$Voltage, type = "l", main = "", xlab="datetime", ylab = "Voltage")
# plot 3 (bottom-left)
...
# plot 4 (bottom-right)
plot(data_small$DateTime_fmt, data_small$Global_reactive_power, type = "l", main="", xlab="datetime", ylab="Global_Reactive_power")
